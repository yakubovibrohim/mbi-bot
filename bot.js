  ...
  for (const [uid, act] of Object.entries(igActivity)) {
    ...
    try {
      const fu = await orChatMessages([
        { role: 'system', content: "Sen MBI Mebel sotuv yordamchisisan. Suhbat to'xtab qolgan mijozga BITTA qisqa, yumshoq, bosimsiz eslatma yoz — Ibrohim uslubida. Namuna ohang: «Нима бўлди, ишлаймизми? Размер ўлчашга борайликми? 😊» — lekin mijozning tilida va yozuvida moslashtir (ruscha yozgan bo'lsa ruscha, lotinda yozsa lotinda), suhbat mazmuniga bog'la. Salom yozma (suhbat davomi), yulduzcha (**) ishlatma, ko'pi bilan 1 savol. Faqat xabar matnini qaytar, boshqa hech narsa." },
        ...hist.slice(-10),
